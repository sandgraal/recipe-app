  ...
  if (loading) {
    return (
      <div className="max-w-6xl mx-auto px-4 py-8 space-y-8">
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 h-72">
          <div className="sm:col-span-3 animate-pulse rounded-3xl" style={{ background: 'var(--border)' }} />
          <div className="sm:col-span-2 flex flex-col gap-4">
            <div className="flex-1 animate-pulse rounded-3xl" style={{ background: 'var(--border)' }} />
            <div className="flex-1 animate-pulse rounded-3xl" style={{ background: 'var(--border)' }} />
          </div>
        </div>
        <div className="flex gap-4">
          {[1,2,3,4].map(i => <div key={i} className="flex-shrink-0 w-48 h-52 animate-pulse rounded-2xl" style={{ background: 'var(--border)' }} />)}
        </div>
      </div>
    );
  }
